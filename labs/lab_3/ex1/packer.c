...
/*  number of balls required to be they can be packed into a box */
#define N 2 // N=2 (in ex1)
...
int get_other_ball_id(int **list_ptr, int id);
...
int pack_ball(int colour, int id) {
    ...
    if (colour == RED) {         
        ...
        if (red_packing_area.n_packing_area == N) {          
            ...
            other_ball_id = get_other_ball_id(&(red_packing_area.id_list), id);
        ...
        if (green_packing_area.n_packing_area == N) {          
            ...
            other_ball_id = get_other_ball_id(&(green_packing_area.id_list), id);
        ...
        if (blue_packing_area.n_packing_area == N) {          
            ...
            other_ball_id = get_other_ball_id(&(blue_packing_area.id_list), id);
...
int get_other_ball_id(int **list_ptr, int id) {    
    ...
    fprintf(stderr, "no other ball found\n");
    return 0;
}
